...
var KhaShmup = function() {
	this.initialized = false;
	kha_Assets.loadEverything($bind(this,this.loadingFinished));
};
$hxClasses["KhaShmup"] = KhaShmup;
KhaShmup.__name__ = true;
KhaShmup.prototype = {
	backbuffer: null
	,initialized: null
	,ship: null
	,loadingFinished: function() {
		...
		var shipImg = kha_Assets.images.playerShip;
		this.ship = new Ship(400 - Std["int"](shipImg.get_width() / 2),300 - Std["int"](shipImg.get_height() / 2),shipImg);
	}
	,render: function(framebuffer) {
		if(!this.initialized) return;
		var g = this.backbuffer.get_g2();
		g.begin(null,KhaShmup.bgColor);
		this.ship.render(g);
		g.end();
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "KhaShmup", width : 800, height : 600},Main.init);
};
Main.init = function() {
...
KhaShmup.bgColor = kha__$Color_Color_$Impl_$._new(2490445);
KhaShmup.screenWidth = 800;
KhaShmup.screenHeight = 600;
